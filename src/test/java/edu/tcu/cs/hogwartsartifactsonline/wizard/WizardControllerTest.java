...
public class WizardControllerTest {
    ...
    void testAssignArtifactSuccess() throws Exception {
        //Given
        doNothing().when(this.wizardService).assignArtifact(2, "125080861744904192");


        //When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.put(this.baseUrl + "/wizards/2/artifacts/125080861744904192").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testAssignArtifactErrorWithNonExistentWizardId() throws Exception {
        //Given
        doThrow(new ObjectNotFoundException("wizard", 5)).when(this.wizardService).assignArtifact(5,"125080861744904192");


        //When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.put(this.baseUrl + "/wizards/5/artifacts/125080861744904192").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find wizard with Id 5 :("))
                .andExpect(jsonPath("$.data").isEmpty());
    ...
    void testAssignArtifactErrorWithNonExistentArtifactId() throws Exception {
        //Given
        doThrow(new ObjectNotFoundException("artifact", "125080861744904199")).when(this.wizardService).assignArtifact(2,"125080861744904199");


        //When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.put(this.baseUrl + "/wizards/2/artifacts/125080861744904199").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find artifact with Id 125080861744904199 :("))
                .andExpect(jsonPath("$.data").isEmpty());
    }
}
